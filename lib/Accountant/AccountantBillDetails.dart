...
class AccountantBillDetails extends StatefulWidget {
  @override
  State<AccountantBillDetails> createState() => _AccountantBillDetailsState();
}

class _AccountantBillDetailsState extends State<AccountantBillDetails> {
          ...
          child: Column(children: [
            ...
            RadioListTile<int>(
              title: Text('تمت الموافقة',
                  style: TextStyle(color: Color(0xff1FCB30))),
              value: 0,
              groupValue: selectedOption,
              activeColor: Color(0xff1FCB30),
              onChanged: (value) {
                setState(() {
